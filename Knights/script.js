$(document).ready(function(){
	...
	function diveInFoo(){
		var lokacija = 'https://empege.github.io/Knights/index.html';
		if(window.location.href != lokacija){
			var destination = 'https://empege.github.io/Knights/index.html';
	...
	$('#arturList').on('click', function(e){
			e.preventDefault();
			var destination = 'https://empege.github.io/Knights/arthurPage.html';
			zatamnjenjeFoo(destination);
	});
	$('#parsifalList').on('click', function(e){
			e.preventDefault();
			var destination = 'https://empege.github.io/Knights/parsifalPage.html';
			zatamnjenjeFoo(destination);
	});
	$('#ritterList').on('click', function(e){
			e.preventDefault();
			var destination = 'https://empege.github.io/Knights/ritterPage.html';
			zatamnjenjeFoo(destination);
	});
	$('#contactPage').on('click', function(e){
			e.preventDefault();
			var destination = 'https://empege.github.io/Knights/contact.html';
			zatamnjenjeFoo(destination);
	});
	...
	$('.slides').on('click', function(){
		...
		if($(this).attr('src') == knight1){
			destination = 'https://empege.github.io/Knights/parsifalPage.html';
			zatamnjenjeFoo(destination);
		}else if($(this).attr('src') == knight2){
			destination = 'https://empege.github.io/Knights/arthurPage.html';
			zatamnjenjeFoo(destination);
		}else if($(this).attr('src') == knight3){
			destination = 'https://empege.github.io/Knights/ritterPage.html';
			zatamnjenjeFoo(destination);}
	});
